...
<ul>
 <li>When user selects Si por favor, it will print all the available items; showing their product number, name, department and price</li>
</ul>
...
<ul>
 <li>Inquirer will prompt user which item they would like to purchase. Using the arrow key, select which item wanting to purchase</li>
</ul>
...
<ul>
 <li>Inqurier will then prompt user how many items they would like to buy. Simply a number value will be placed here</li>
</ul>
...
<ul>
 <li>After selecting the quantity of items to purchase, it will either prompt a success (like in the picture) or it will prompt that there's insufficient quantity</li>
</ul>
